    ...
    >
            ...
            >
              ...
              <div
                style={{
                  ...
                  width: "36px",
                  height: "36px",
                  borderTop: "1.5px solid #C8A15A",
                  borderRight: "1.5px solid #C8A15A",
                  opacity: 0.6,
                  zIndex: 1,
                }}
              />
              <div
                style={{
                  ...
                  width: "36px",
                  height: "36px",
                  borderBottom: "1.5px solid #C8A15A",
                  borderLeft: "1.5px solid #C8A15A",
                  opacity: 0.6,
                  zIndex: 1,
                }}
              />
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                {ventures.map(({ year, name }, i) => (
                  ...
                  >
                    <span
                      className="font-body"
                      style={{ fontSize: "0.7rem", color: "#444", flexShrink: 0, width: "3rem" }}
                    >
                      {year}
                    </span>
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .portrait-card { max-height: 420px !important; }
          .portrait-card img { object-position: center 30% !important; }
        }
      `}</style>
    </section>
  );
